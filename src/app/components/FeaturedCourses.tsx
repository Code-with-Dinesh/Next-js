...
const FeaturedCourses = () => {
  const data = courseData.courses.filter(
    (elem: course) => elem.isFeatured === true
  );
  return (
    <div className="py-12 bg-gray-900">
      <div>
        <h2 className="text-center text-teal-600">FEATURE COURSES</h2>
        <p className="text-center mt-2 text-3xl leading-8 font-extrabold tracking-normal text-white sm:text-4xl">
          Learn From The Best
        </p>
      </div>
      <div className="mt-20">
      ...
      <div className="mt-20 text-center">
        <Link
          href={"/courses"}
          className="px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-100 transition-all duration-200"
        >
          View All courses
        </Link>
      </div>
